...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton.setStyleSheet(
            "background-image: url(:/setu1/ziyuan/d5177cc8c9de103428d4e09c41ca08fb.jpg);\n"
            "color: rgb(0, 255, 255);\n"
            'font: 26pt "方正舒体";'
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(
            _translate(
                "Form",
                "<html><head/><body><p>欢迎使用“二次元图片下载器最终纪念版本”！</p><p>祝你下载图片过得愉快！</p></body></html>",
            )
        )
        ...
        self.label_3.setText(
            _translate(
                "Form",
                '<html><head/><body><p align="center">作者：scu机工  赵某</p><p>QQ(小号)3439912523，欢迎交流</p></body></html>',
            )
        )
        self.label_4.setText(
            _translate(
                "Form",
                "<html><head/><body><p>请输入你所期望</p><p>的图片的张数</p></body></html>",
            )
        )
